...
node.default[:mon_agent][:plugin][:jahmon_http_check][:init_config] = {
}

node.default[:mon_agent][:plugin][:jahmon_http_check][:instances][:monapi] = {
  :name => "mon_api",
...
node.default[:mon_agent][:plugin][:jahmon_http_check][:instances][:monapi_health] = {
  :name => "mon_api_health",
